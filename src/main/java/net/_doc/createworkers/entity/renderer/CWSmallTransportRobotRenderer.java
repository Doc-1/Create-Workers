...
public class CWSmallTransportRobotRenderer extends MobRenderer<CWSmallTransportRobotEntity, CWSmallTransportRobotModel<CWSmallTransportRobotEntity>> {
    
    public CWSmallTransportRobotRenderer(Context pContext) {
        super(pContext, new CWSmallTransportRobotModel<>(pContext.bakeLayer(CWModelLayers.CW_SMALL_TRANSPORT_LAYER)), 0.7F);
    }
