...
import net._doc.createworkers.content.items.HolePunchItem;
...
public class CWItems {
    ...
    public static final ItemEntry<HolePunchItem> HOLE_PUNCHER = CreateWorkers.REGISTRATE.item("hole_puncher", HolePunchItem::new).properties(p -> p.stacksTo(1))
