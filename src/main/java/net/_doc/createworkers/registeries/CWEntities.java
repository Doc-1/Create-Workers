...
public class CWEntities {
    ...
    public static final RegistryObject<EntityType<CWSmallTransportRobotEntity>> CW_SMALL_TRANSPORT_ROBOT = ENTITY_TYPES.register("small_transport_robot", () -> EntityType.Builder
            .of(CWSmallTransportRobotEntity::new, MobCategory.CREATURE).sized(1.5F, 1.5F).build("small_transport_robot"));
