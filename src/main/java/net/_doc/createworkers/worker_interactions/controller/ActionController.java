package net._doc.createworkers.worker_interactions.controller;

import java.util.ArrayList;
import java.util.List;

import net._doc.createworkers.worker_interactions.controller.actions.Action;
...
public class ActionController {
    ...
    public boolean tick() {
        if (steps.size() > selectedIndex) {
            ...
            if (action.getEntity().getTorque() != null && action.getEntity().getTorque().hasEnoughTorque(action.torqueCost())) {
