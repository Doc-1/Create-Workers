...
public class GuiScrollNumberField extends GuiScrollDecimalField<Integer> {
    ...
    @Override
    public GuiScrollNumberField setMaxDecimalOnly(Integer max) {
    ...
    @Override
    public GuiScrollNumberField setMinDecimalOnly(Integer min) {
        this.min = min;
    ...
    @Override
    public GuiScrollNumberField setMinMaxDciaml(Integer min, Integer max) {
        this.min = min;
        this.max = max;
        this.setValidator((x) -> {
            if (x.isEmpty())
